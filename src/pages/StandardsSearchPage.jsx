            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-1">
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-600 mt-1 max-w-3xl leading-relaxed">
                  Search Indian Standards by IS number, product, keyword or sector.
                </p>
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <span className="px-2.5 py-1 rounded-sm text-xs font-mono font-bold bg-gov-100 text-gov-800 border border-gov-300">
                  {results.length} Standards Indexed
                </span>
              </div>
            </div>
          </div>
