...
export default function ServicesPage() {
  ...
  const [activeView, setActiveView] = useState('DIRECTORY'); // 'DIRECTORY' | 'COMPLIANCE'
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-slate-50 text-slate-900 text-left">
        ...
        {/* HEADER SECTION */}
        <section className="bg-white border-b border-slate-300 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-3">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-1">
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-600 mt-1 max-w-3xl leading-relaxed">
                  Institutional guide to statutory conformity schemes, standardization divisions, laboratory networks, and citizen services operated by the Bureau of Indian Standards.
                </p>
              </div>
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-slate-200">
              ...
              >
                ...
                <span>Interactive Compliance Checker (7-Stage Audit)</span>
              </button>
            </div>
          </div>
        </section>
        ...
        {activeView === 'DIRECTORY' ? (
          <>
            ...
            <div className="bg-slate-100 border-b border-slate-300 sticky top-0 z-10">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-1 overflow-x-auto py-2 text-xs">
                <button
                ...
                <div key={catGroup.categoryKey} className="space-y-3">
                  ...
                  <div className="space-y-3">
                    {catGroup.services.map((item) => (
                      <div
                        key={item.id}
                        className="bg-white border border-slate-300 rounded-sm p-4 sm:p-5 hover:border-gov-800 transition-all space-y-3 shadow-sm"
                      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <ComplianceChecker
              ...
              onOpenStandard={(std) => navigate(`/standards?code=${encodeURIComponent(std.standard_number || std.code || '')}`)}
            />
          </div>
        )}
